OpportunityNotificationConfig file determines defaults opportunity amount and stage, which trigger notifications and sharing. Amoutn, Stage and User Role can be configured in custom settings.
